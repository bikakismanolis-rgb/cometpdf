# CometPDF Microsoft Store Submission Draft

Use this as copy/paste material for Microsoft Partner Center.
...
Convert Office files, images, emails, and text files to PDF privately on Windows.
...
CometPDF supports common office workflows:

- Word documents: DOC, DOCX, RTF, ODT
- Excel spreadsheets: XLS, XLSX, XLSM, ODS, CSV
...
CometPDF does not require an account and does not upload your documents to CometPDF servers.
